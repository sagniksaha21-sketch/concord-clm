...
import { getInbox, readInbox, getPermissions } from '@/app/lib/api';
...
export default function InboxPage() {
  const [canReadRequests, setCanReadRequests] = useState(false);
  ...
  useEffect(() => { void load(); getPermissions().then(p => setCanReadRequests(p.permissions.includes('request:read'))).catch(() => undefined); }, [load]);
