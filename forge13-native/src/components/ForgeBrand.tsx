...
const styles=StyleSheet.create({
  ...
  f:{fontSize:27,fontWeight:'900',color:'#120B03',fontStyle:'italic',letterSpacing:-2.3},
  ...
  word:{fontSize:30,fontWeight:'900',fontStyle:'italic',letterSpacing:-1.65,lineHeight:31,textShadowColor:'rgba(245,166,35,.18)',textShadowRadius:8},
