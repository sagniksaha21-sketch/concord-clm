...
export function ForgeButton({label,onPress,ghost=false,style}:{label:string;onPress:()=>void;ghost?:boolean;style?:ViewStyle}) {
...
const styles=StyleSheet.create({btn:{height:48,borderRadius:15,alignItems:'center',justifyContent:'center',borderWidth:1,paddingHorizontal:16},txt:{fontSize:12,fontWeight:'1000',letterSpacing:.8,textTransform:'uppercase'}});
