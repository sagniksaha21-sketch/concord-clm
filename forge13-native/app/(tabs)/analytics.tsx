...
export default function Analytics(){
 const router=useRouter(),{state,theme}=useForge(); const tr=last30(state),hof=hallOfFame(state),featured=hof[0],body=state.bodyLogs?.at(-1),muscles=topMuscles(state);
 return <Screen>
...
const styles=StyleSheet.create({metrics:{flexDirection:'row',gap:9},metricCard:{flex:1,padding:12,minHeight:92},hof:{gap:14},hofTop:{flexDirection:'row',gap:13},crown:{width:42,height:42,borderRadius:14,alignItems:'center',justifyContent:'center'},crownText:{color:'#160D03',fontSize:18,fontWeight:'1000'},eyebrow:{fontSize:8.5,fontWeight:'900',letterSpacing:1.45},hofName:{fontSize:19,fontWeight:'1000',letterSpacing:-.5,marginTop:5},hofValue:{fontSize:18,fontWeight:'950',marginTop:5},micro:{fontSize:9.5,lineHeight:14,fontWeight:'650'},plaques:{flexDirection:'row',flexWrap:'wrap',gap:8},plaque:{width:'100%',borderWidth:1,borderRadius:16,padding:11,minHeight:105},plaqueName:{fontSize:11,fontWeight:'900',lineHeight:14},plaqueMark:{fontSize:13,fontWeight:'950',marginTop:12},bodyStats:{flexDirection:'row',justifyContent:'space-between',gap:16},bodyValue:{fontSize:25,fontWeight:'1000',marginTop:3},open:{borderWidth:1,borderRadius:14,padding:13,alignItems:'center'},openText:{fontSize:8.5,fontWeight:'950',letterSpacing:.8}});
