...
export default function ExercisePicker(){
 ...
 const rankedMatches=useMemo(()=>params.mode==='workout'&&current?rankedSubstitutes(current.id):[],[params.mode,current?.id]);
 const ranked=useMemo(()=>params.mode==='workout'?rankedMatches.map(x=>x.exercise):(exercises as any[]),[params.mode,rankedMatches]);
